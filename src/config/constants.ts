...
export const GATEWAY_URL_STAGING =
  process.env.NEXT_PUBLIC_GATEWAY_URL_STAGING ||
...
export const LATEST_SAFE_VERSION =
  process.env.NEXT_PUBLIC_SAFE_VERSION || "1.4.1";
...
export const SAFE_APPS_INFURA_TOKEN =
  process.env.NEXT_PUBLIC_SAFE_APPS_INFURA_TOKEN || INFURA_TOKEN;
...
export const TENDERLY_ORG_NAME =
  process.env.NEXT_PUBLIC_TENDERLY_ORG_NAME || "";
...
export const IS_OFFICIAL_HOST =
  process.env.NEXT_PUBLIC_IS_OFFICIAL_HOST === "true";

// Risk mitigation (Redefine)
export const REDEFINE_SIMULATION_URL =
  "https://dashboard.redefine.net/reports/";
...
export const CHAINALYSIS_OFAC_CONTRACT =
